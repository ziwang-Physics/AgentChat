...
# 4 路并发编排 — 任务自动拆解 + 证据仲裁
/AgentChat-FreeSubAgent 量子点做什么容易发Nature（默认ChatGPT+Gemini+Kimi+Qwen）

# Gemini Pro Extended Thinking
/gemini-web-extended-thinking "深度分析..."
```
...
| **gemini-web-extended-thinking** | Gemini Pro Extended Thinking 激活 | 旧版本，只用Gemini |
