...
# 必须使用 Playwright Chromium: /home/user/.cache/ms-playwright/chromium-1228/chrome-linux64/chrome
...
> ⚠️ **Chrome 二进制**: 必须使用 Playwright 自带的 Chromium (`/home/user/.cache/ms-playwright/chromium-1228/chrome-linux64/chrome`)，不能用 Chrome for Testing (CfT)。详见下方 "Chrome 导航失败诊断" 章节。
...
```bash
# 1. 复制代码到 NFS
cp -r /home/user/GemiNode-Swarm /mnt/data/
